   ...
   <form:form class="form-horizontal" action="saveRouteCode.html" method="post" commandName="routeCode">
      <div class="content-wrapper">					
       <section class="content-header">
         <h1>
            Free Mind Services<small>Route Codes</small>
         </h1>
         <ol class="breadcrumb">
            ...
            <div class="tab-pane active" id="general_info">
                <div class="box-body">
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Route Code Id:<span class="required">*</span></label>
                    <div class="col-sm-3">
                      <form:input type="text" readOnly="true" placeholder="Route Code ID" class="form-control" value="${routeCode.route_code_id}" path="route_code_id" />
                    </div> 
                    <label class="col-sm-2 control-label">Route Code Name:<span class="required">*</span></label>
                    <div class="col-sm-3">
                      <form:input type="text" class="form-control" placeholder="Route Code Name" path="route_code_name" value="${routeCode.route_code_name}"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-5">
                      <button type="submit" formmethod="post" formaction="routeCodeList.html" class="btn btn-success pull-right">View</button>
                    </div> 
                    <div class="col-sm-1">
