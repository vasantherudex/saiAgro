...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
   <form:form class="form-horizontal" action="saveState.html" method="post" commandName="state">
      <div class="content-wrapper">
       <section class="content-header">
         <h1>
            Free Mind Services<small>State</small>
         </h1>
         <ol class="breadcrumb">
       ...
       <section class="content">
         ...
         <div class="nav-tabs-custom">
           <ul class="nav nav-tabs">
            <li class="active"><a href="#general_info" data-toggle="tab">State Information</a></li>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="general_info">
                <div class="box-body">
                <h3>Available State Names</h3>
                    <table id="stateListTable" class="table table-bordered table-hover dataTableList">
                       <thead>
		                <tr>
			              <th>State ID</th>
			              <th>State Name</th>
		               ...
		               <tbody>
			            ...
			            <tr>
				           <td><c:out value="${state.state_id}"/></td>
				           <td><c:out value="${state.state_name}"/></td>
				           <td>
				            <div class="col-sm-3">
				            <button type="submit" formmethod="post" formaction='editState.html?state_id=<c:out value="${state.state_id}"/>' class="btn btn-default">Edit</button>
				           </div>
				            <div class="col-sm-2">
				            <button type="submit" formmethod="post" formaction='deleteState.html?state_id=<c:out value="${state.state_id}"/>' class="btn btn-danger">Delete</button>
				           </div>
				           </td>
			            </tr>
		                </c:forEach>
