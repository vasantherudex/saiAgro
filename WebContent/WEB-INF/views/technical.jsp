            ...
            <div class="tab-pane active" id="general_info">
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <form:input type="text" class="form-control" readonly="true" placeholder="Technical Id" value="${technical.technical_id}" path="technical_id" />
                    </div> 
                  ...
                  <div class="form-group">
                    <div class="col-sm-5">
                      <button type="submit" formmethod="post" formaction="technicalList.html" class="btn btn-success pull-right">View</button>
                    </div> 
                    <div class="col-sm-1">
