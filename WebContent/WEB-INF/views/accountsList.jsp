   ...
   <form:form class="form-horizontal" action="saveAccounts.html" method="post" commandName="accounts">
      <div class="content-wrapper">
       <section class="content-header">
         <h1>
            Free Mind Services<small>Accounts List</small>
         </h1>
         <ol class="breadcrumb">
       ...
       <section class="content">
         ...
         <div class="nav-tabs-custom">
           <ul class="nav nav-tabs">
            <li class="active"><a href="#general_info" data-toggle="tab">Accounts List Information</a></li>
                    ...
                    <table id="example1" class="table table-bordered table-hover dataTableList">
		              ...
		              <tbody>
			            ...
			            <tr>
				           ...
				           <td><c:out value="${account.account_name}"/></td>
				           <td>
				            <div class="col-sm-3">
				            <button type="submit" formmethod="post" formaction='editAccount.html?account_id=<c:out value="${account.account_id}"/>' class="btn btn-default">Edit</button>
				           </div>
				            <div class="col-sm-2">
				            <button type="submit" formmethod="post" formaction='deleteAccount.html?account_id=<c:out value="${account.account_id}"/>' class="btn btn-danger">Delete</button>
				           </div>
				           </td>
			            </tr>
		                </c:forEach>
