...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
   <form:form class="form-horizontal" action="saveRouteCode.html" method="post" commandName="routeCode">
      <div class="content-wrapper">
       <section class="content-header">
         <h1>
            Free Mind Services<small>Route Code</small>
         </h1>
         <ol class="breadcrumb">
       ...
       <section class="content">
         ...
         <div class="nav-tabs-custom">
           <ul class="nav nav-tabs">
            <li class="active"><a href="#general_info" data-toggle="tab">Route Code Information</a></li>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="general_info">
                <div class="box-body">
                <h3>Available Route Code Names</h3>
                    <table id="routeCodeListTable" class="table table-bordered table-hover dataTableList">
                       <thead>
		                <tr>
			              <th>Route Code ID</th>
		               ...
		               <tbody>
		                <c:forEach items="${routeCodeList}" var="routeCode">
			            <tr>
				           <td><c:out value="${routeCode.route_code_id}"/></td>
				           <td><c:out value="${routeCode.route_code_name}"/></td>
				           <td>
				            <div class="col-sm-3">
				            <button type="submit" formmethod="post" formaction='editRouteCode.html?route_code_id=<c:out value="${routeCode.route_code_id}"/>' class="btn btn-default">Edit</button>
				           </div>
				            <div class="col-sm-2">
				            <button type="submit" formmethod="post" formaction='deleteRouteCode.html?route_code_id=<c:out value="${routeCode.route_code_id}"/>' class="btn btn-danger">Delete</button>
				           </div>
				           </td>
			            </tr>
		                </c:forEach>
