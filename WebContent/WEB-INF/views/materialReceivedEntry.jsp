...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
  <form:form class="form-horizontal" action="saveMaterialReceivedEntry.html" method="post" commandName="materialReceivedEntry">
...
<%--                          <form:input type="text" class="form-control" placeholder="Dc No" path="dc_no"/> --%>
                ...
                <div class="box-body">
                 <div class="col-sm-12">
                  ...
                  <div class="col-sm-14">
                  <label class="col-sm-4"><strong>Product List:</strong><span class="required">*</span></label>
                  <table id="example1" class="table">
                    <thead>
                      ...
                      <tr>
                        <th class="col-sm-1">
                          <input type="text" placeholder="ProductCode" name="product_code" id="product_code" class="form-control product_code" onKeyup="getProducts(this.value);">
                        ...
                        <th class="col-sm-1"><input type="text" placeholder="Rate" name="rate" id="rate" class="form-control" ></th>
                        <th class="col-sm-1"><input type="text" placeholder="Batch" name="batch" id="batch" class="form-control" ></th>
                        <th class="col-sm-2"><input type="text" placeholder="MfgDate" name="mfgdate" id="mfgdate" class="form-control datepicker" ></th>
                        <th class="col-sm-2"><input type="text" placeholder="ExpDate" name="expdate" id="sale_rate" class="form-control sale_rate datepicker" onkeydown="addMoreProduct(event);"></th>
                      </tr>
