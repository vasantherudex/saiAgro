         ...
         <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="general_info">
                <div class="box-body">
                  <h3 class="text-center">Available Products Information</h3>
		               ...
		               <tbody>
		                <c:forEach items="${productList}" var="product">
			             <tr>
				           ...
				           <td><c:out value="${product.technical_id}"/></td>
				           <td><c:out value="${product.sale_rate}"/></td>
				           <td><c:out value="${product.purchase_rate}"/></td>
				           <td>
				            <div class="col-sm-3">
