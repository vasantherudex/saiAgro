   ...
   <form:form class="form-horizontal" action="saveAccountType.html" method="post" commandName="accountType">
      <div class="content-wrapper">
       <section class="content-header">
         <h1>
            Free Mind Services<small>AccountType List</small>
         </h1>
         <ol class="breadcrumb">
         ...
         <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="general_info">
                <div class="box-body">
                <h3>Available Account Type Information</h3>
                    <table id="accountTypeListTable" class="table table-bordered table-hover dataTableList">
                       <thead>
		                <tr>
		               ...
		               <tbody>
			            ...
			            <tr>
				           <td><c:out value="${accountType.account_type_id}"/></td>
				           <td><c:out value="${accountType.account_type_name}"/></td>
				           <td>
				            <div class="col-sm-3">
				            <button type="submit" formmethod="post" formaction='editAccountType.html?account_type_id=<c:out value="${accountType.account_type_id}"/>' class="btn btn-default">Edit</button>
				           </div>
				            <div class="col-sm-2">
				            <button type="submit" formmethod="post" formaction='deleteAccountType.html?account_type_id=<c:out value="${accountType.account_type_id}"/>' class="btn btn-danger">Delete</button>
				           </div>
				           </td>
			            </tr>
		                </c:forEach>
