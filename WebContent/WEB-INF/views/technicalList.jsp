         ...
         <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="general_info">
                <div class="box-body">
                <h3>Available Technical Names</h3>
                    <table id="technicalListTable" class="table table-bordered table-hover dataTableList">
                       <thead>
		                <tr>
			              <th>Technical ID</th>
		               ...
		               <tbody>
		                <c:forEach items="${technicalList}" var="technical">
			            <tr>
				           <td><c:out value="${technical.technical_id}"/></td>
				           <td><c:out value="${technical.technical_name}"/></td>
				           <td>
				            <div class="col-sm-3">
				            <button type="submit" formmethod="post" formaction='editTechnical.html?technical_id=<c:out value="${technical.technical_id}"/>' class="btn btn-default">Edit</button>
				           </div>
				            <div class="col-sm-2">
				            <button type="submit" formmethod="post" formaction='deleteTechnical.html?technical_id=<c:out value="${technical.technical_id}"/>' class="btn btn-danger">Delete</button>
				           </div>
				           </td>
			            </tr>
		                </c:forEach>
