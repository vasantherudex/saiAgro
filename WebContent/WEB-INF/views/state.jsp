            ...
            <div class="tab-pane active" id="general_info">
                <div class="box-body">
                  <div class="form-group">
                    <label class="col-sm-2 control-label">State Id:<span class="required">*</span></label>
                    <div class="col-sm-3">
                      <form:input type="text" readOnly="true" placeholder="State Id" class="form-control" value="${state.state_id}" path="state_id" />
                    </div> 
                    <label class="col-sm-2 control-label">State Name:<span class="required">*</span></label>
                    <div class="col-sm-3">
                      <form:input type="text" class="form-control" placeholder="State Name" path="state_name" value="${state.state_name}"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-5">
                      <button type="submit" formmethod="post" formaction="stateList.html" class="btn btn-success pull-right">View</button>
                    </div> 
                    <div class="col-sm-1">
