...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
   <form:form class="form-horizontal" action="saveAccountType.html" method="post" commandName="accountType">
      <div class="content-wrapper">
       <section class="content-header">
         <h1>
            Free Mind Services<small>Account Type</small>
         </h1>
         <ol class="breadcrumb">
       ...
       <section class="content">
         ...
         <div class="nav-tabs-custom">
           <ul class="nav nav-tabs">
            <li class="active"><a href="#general_info" data-toggle="tab">Account Type Information</a></li>
            ...
            <div class="tab-pane active" id="general_info">
                <div class="box-body">
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Account Type Id:<span class="required">*</span></label>
                    <div class="col-sm-3">
                      <form:input type="text" class="form-control" readonly="true" placeholder="Account Type Id" path="account_type_id" value="${accountType.account_type_id}" />
                    </div> 
                    <label class="col-sm-2 control-label">Account Type Name:<span class="required">*</span></label>
                    <div class="col-sm-3">
                      <form:input type="text" class="form-control" placeholder="Account Type Name" path="account_type_name" value="${accountType.account_type_name}"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-5">
                      <button type="submit" formmethod="post" formaction="accountTypeList.html" class="btn btn-success pull-right">View</button>
                    </div> 
                    <div class="col-sm-1">
