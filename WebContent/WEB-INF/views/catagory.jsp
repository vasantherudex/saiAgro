   ...
   <form:form class="form-horizontal" action="saveCatagory.html" method="post" commandName="catagory">
      <div class="content-wrapper">
       <section class="content-header">
         <h1>
            Free Mind Services<small>Catagory</small>
         </h1>
         <ol class="breadcrumb">
            ...
            <div class="tab-pane active" id="general_info">
                <div class="box-body">
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Catagory Id:<span class="required">*</span></label>
                    <div class="col-sm-3">
                      <form:input type="text" class="form-control" placeholder="Catagory Id" readOnly="true" value="${catagory.catagory_id}" path="catagory_id" />
                    </div> 
                    <label class="col-sm-2 control-label">Catagory Name:<span class="required">*</span></label>
                    <div class="col-sm-3">
                      <form:input type="text" class="form-control" placeholder="Catagory Name" path="catagory_name" value="${catagory.catagory_name}"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-5">
                      <button type="submit" formmethod="post" formaction="catagoryList.html" class="btn btn-success pull-right">View</button>
                    </div> 
                    <div class="col-sm-1">
