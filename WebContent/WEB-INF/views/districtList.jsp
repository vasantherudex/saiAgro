...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
   <form:form class="form-horizontal" action="saveDistrict.html" method="post" commandName="district">
      <div class="content-wrapper">
       <section class="content-header">
         <h1>
            Free Mind Services<small>District</small>
         </h1>
         <ol class="breadcrumb">
       ...
       <section class="content">
         ...
         <div class="nav-tabs-custom">
           <ul class="nav nav-tabs">
            <li class="active"><a href="#general_info" data-toggle="tab">District Information</a></li>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="general_info">
                <div class="box-body">
                <h3>Available District Names</h3>
                    <table id="districtListTable" class="table table-bordered table-hover dataTableList">
                       <thead>
		                <tr>
			              <th>District ID</th>
			              <th>State ID</th>
		               ...
		               <tbody>
			            ...
			            <tr>
				           <td><c:out value="${district.district_id}"/></td>
				           <td><c:out value="${district.state_id}"/></td>
				           <td><c:out value="${district.district_name}"/></td>
				           <td>
				            <div class="col-sm-3">
				            <button type="submit" formmethod="post" formaction='editDistrict.html?district_id=<c:out value="${district.district_id}"/>' class="btn btn-default">Edit</button>
				           </div>
				            <div class="col-sm-2">
				            <button type="submit" formmethod="post" formaction='deleteDistrict.html?district_id=<c:out value="${district.district_id}"/>' class="btn btn-danger">Delete</button>
				           </div>
				           </td>
			            </tr>
		                </c:forEach>
