            ...
            <div class="tab-pane active" id="general_info">
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                       <form:select class="form-control" path="state_id">
                    ...
                    <div class="col-sm-3">
                      <form:input type="text" path="district_name" class="form-control" placeholder="District Name"/>
                      <form:input type="hidden" path="district_id"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-5">
                      <button type="submit" formmethod="post" formaction="districtList.html" class="btn btn-success pull-right">View</button>
                    </div> 
                    <div class="col-sm-1">
